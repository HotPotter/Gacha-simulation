if __name__ == '__main__':
    ...
    for i in range (0, config.player_num):
        ...
        trans_interval = convert.transpose_interval(completion_interval)
    ...
    convert.output_csv_all_players_trans_interval(all_trans_interval) # 2. write csv to transposed completion interval
    convert.output_csv_all_players_completion_names(all_player_completion_names) # 3. write csv of the order of how each player complete the items
